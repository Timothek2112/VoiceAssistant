...
class VoiceAssistant:
    ...
    def setup(self):
        with open(r'C:/VoiceAssistant/prop', 'r+') as file:
    ...
    def load_properties(self):
        if os.path.exists(r'C:/VoiceAssistant/prop'):
            with open(r'C:/VoiceAssistant/prop') as file:
...
def get_intent(request):
    ...
    if best_intent_probability > 0.25:
